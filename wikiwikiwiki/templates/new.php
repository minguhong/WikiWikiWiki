  ...
  <div class="section-main">
    <form class="form is-fill" id="form" method="post">
      ...
      <div class="field">
        ...
        <input class="input" id="title" type="text" name="title" pattern="<?= html(page_title_input_pattern()) ?>" maxlength="<?= PAGE_TITLE_MAX_LENGTH ?>" value="<?= html($inputTitle ?? '') ?>" placeholder="<?= t('field.placeholder.page_title') ?>" spellcheck="false" required autofocus>
      ...
      <div class="field is-sticky">
        <div class="buttons">
          <div>
            <a class="button" id="button-cancel" href="<?= html(url('/')) ?>"><?= t('button.cancel') ?></a>
          </div>
          <div>
