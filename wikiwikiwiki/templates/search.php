              ...
              <li>
                <div class="content">
                  <?php if (((string) ($result['parentPath'] ?? '')) !== ''): ?>
                    <a href="<?= url((string) $result['parentPath']) ?>"><?= html((string) $result['parentPath']) ?></a>
                    <span aria-hidden="true">/</span>
                  <?php endif ?>
                  <a href="<?= url($result['title']) ?>"><?= html($result['title']) ?></a>
                  <?php if (((string) ($result['redirectTarget'] ?? '')) !== ''): ?>
                    <span aria-hidden="true">→</span>
                    <a href="<?= url((string) $result['redirectTarget']) ?>"><?= html((string) $result['redirectTarget']) ?></a>
                  <?php endif ?>
                </div>
