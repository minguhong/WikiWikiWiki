<section class="section">
  ...
  <div class="section-main">
    <form class="form" action="<?= html((string) ($loginActionUrl ?? url('/login'))) ?>" method="post">
      ...
      <div class="field">
        <label class="checkbox" for="remember_login">
          <input id="remember_login" type="checkbox" name="remember_login" value="1" <?= !empty($rememberLoginChecked) ? 'checked' : '' ?>>
          <span><?= t('field.label.remember_login') ?></span>
        </label>
      </div>
      <div class="field">
