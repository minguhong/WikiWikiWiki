<section class="section">
  ...
  <div class="section-main">
    <form class="form is-fill" id="form" action="<?= html(url($page)) ?>" method="post">
      ...
      <?php if (!$isNew && $page !== HOME_PAGE): ?>
        <div class="field">
          ...
          <input class="input" id="new-title" type="text" name="new_title" value="<?= html((string) ($newTitleInput ?? $page)) ?>" pattern="<?= html(page_title_input_pattern()) ?>" maxlength="<?= PAGE_TITLE_MAX_LENGTH ?>" placeholder="<?= t('field.placeholder.page_title') ?>">
      ...
      <div class="field is-sticky">
        <div class="buttons">
          <div>
            <a class="button" id="button-cancel" href="<?= $isNew ? html(url('/')) : html(url($page)) ?>"><?= t('button.cancel') ?></a>
          </div>
          <div>
